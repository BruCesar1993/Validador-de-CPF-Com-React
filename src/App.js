...
function App() {
  ...
  return (
    ...
    <div id="pesquisador" class="input-group mb-3">
        <input id="ent" type="text" class= {borda}  placeholder="digite o erro" aria-label="Recipient's username" aria-describedby="basic-addon2" type="number" onChange={e => setEntrada(e.target.value)} />
    ...
    <div class= {fundo} >
      <div class="card-header"></div>
      <div class="card-body">
        <h5 class="card-title text-center">CPF {resultado2}</h5>
      </div>
    </div>
